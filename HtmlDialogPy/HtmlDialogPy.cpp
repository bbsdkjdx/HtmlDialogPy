...
BEGIN_MESSAGE_MAP(CHtmlDialogPyApp, CWinApp)
...
CHtmlDialogPyApp::CHtmlDialogPyApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CHtmlDialogPyApp 对象

CHtmlDialogPyApp theApp;


// CHtmlDialogPyApp 初始化

BOOL CHtmlDialogPyApp::InitInstance()
{
